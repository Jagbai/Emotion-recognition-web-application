...
model.add(Conv2D(neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
model.add(Dropout(0.5))

model.add(Conv2D(2 * neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(Conv2D(2 * neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
...
model.add(Conv2D(2 * 2 * neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(Conv2D(2 * 2 * neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
...
model.add(Conv2D(2 * 2 * 2 * neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(Conv2D(2 * 2 * 2 * neuron_numb, kernel_size=(3, 3), activation='relu', padding='same'))
model.add(BatchNormalization())
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
...
model.add(Dense(2 * 2 * 2 * neuron_numb, activation='relu'))
model.add(Dropout(0.4))
model.add(Dense(2 * 2 * neuron_numb, activation='relu'))
model.add(Dropout(0.4))
model.add(Dense(2 * neuron_numb, activation='relu'))
model.add(Dropout(0.5))
